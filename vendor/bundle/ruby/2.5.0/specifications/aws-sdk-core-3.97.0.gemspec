# -*- encoding: utf-8 -*-
# stub: aws-sdk-core 3.97.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<aws-partitions>.freeze, [">= 1.239.0", "~> 1"])
      s.add_runtime_dependency(%q<aws-sigv4>.freeze, ["~> 1.1"])
      s.add_runtime_dependency(%q<aws-eventstream>.freeze, [">= 1.0.2", "~> 1"])
    else
      s.add_dependency(%q<jmespath>.freeze, ["~> 1.0"])
      s.add_dependency(%q<aws-partitions>.freeze, [">= 1.239.0", "~> 1"])
      s.add_dependency(%q<aws-sigv4>.freeze, ["~> 1.1"])
      s.add_dependency(%q<aws-eventstream>.freeze, [">= 1.0.2", "~> 1"])
    end
  else
    s.add_dependency(%q<jmespath>.freeze, ["~> 1.0"])
    s.add_dependency(%q<aws-partitions>.freeze, [">= 1.239.0", "~> 1"])
